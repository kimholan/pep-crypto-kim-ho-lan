...
import nl.logius.pepcrypto.api.ApiReshuffable;
...
public class ApiSignedEncryptedPseudonymDecryptionTest {

    @InjectMocks
    private ApiSignedEncryptedPseudonymDecryption service;
    ...
    private ApiDecryption<ApiReshuffable> signedEncryptedPseudonym;
