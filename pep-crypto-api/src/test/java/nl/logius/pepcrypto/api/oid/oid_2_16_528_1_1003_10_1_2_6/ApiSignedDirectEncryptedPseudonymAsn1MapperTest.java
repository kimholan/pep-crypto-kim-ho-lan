...
public class ApiSignedDirectEncryptedPseudonymAsn1MapperTest {

    @InjectMocks
    private ApiSignedDirectEncryptedPseudonymAsn1Mapper mapper;

    @Test
    public void map() {
        var bytes = resourceToByteArray("/v1/happy_flow/dep12.asn1");
        ...
        verify(mappable).setMappedInput(any(Asn1SignedDirectEncryptedPseudonymEnvelope.class));
    }
