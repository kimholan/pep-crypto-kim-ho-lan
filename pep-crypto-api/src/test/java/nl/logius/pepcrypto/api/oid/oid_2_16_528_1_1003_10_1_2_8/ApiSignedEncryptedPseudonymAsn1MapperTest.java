...
public class ApiSignedEncryptedPseudonymAsn1MapperTest {

    @InjectMocks
    private ApiSignedEncryptedPseudonymAsn1Mapper mapper;

    @Test
    public void map() {
        var bytes = resourceToByteArray("/legacy/ep02.asn1");
