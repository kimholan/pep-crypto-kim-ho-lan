...
public class ApiSignedDirectEncryptedPseudonymExchangeTest {

    @Test
    public void getDecryptionFunction() {
        var mock = mock(ApiSignedDirectEncryptedPseudonymExchange.class);
        ...
        verify(mock).getSelectedDirectReceiveKey();
