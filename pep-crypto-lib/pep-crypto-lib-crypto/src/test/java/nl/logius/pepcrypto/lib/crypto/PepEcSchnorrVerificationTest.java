...
public class PepEcSchnorrVerificationTest {
    ...
    public void nullArgs() {
        ...
        for (var arg : args) {
            try {
                ...
                PepEcSchnorrVerification.verify(signedData, verificationKey1, signature);
                fail();
            } catch (PepRuntimeException cause) {
                assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
    ...
    public void rValueHasInvalidBitLength() {
        ...
        try {
            PepEcSchnorrVerification.verify(signedData, verificationKey, signature);
            fail();
        } catch (PepRuntimeException cause) {
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_R_BOUNDS_MAX));
        }
    }
    ...
    public void rValueNotPositiveValue() {
        ...
        try {
            ...
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_R_BOUNDS_MIN));
        }
    }
    ...
    public void sValueNotPositiveValue() {
        ...
        try {
            ...
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_S_BOUNDS_MIN));
        }
    }
    ...
    public void sValueNotWithinOrder() {
        ...
        try {
            ...
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_S_BOUNDS_MAX));
        }
    }
    ...
    public void publicKeyNotInfinity() {
        ...
        try {
            ...
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_PUBLIC_KEY_INFINITY));
        }
    }
    ...
    public void recipientKeyNotInfinity() {
        ...
        try {
            ...
            assertTrue(cause.isExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR));
            assertTrue(cause.hasExceptionDetail(VERIFY_SIGNATURE_ECSCHNORR_RECIPIENT_KEY_INFINITY));
        }
    }
