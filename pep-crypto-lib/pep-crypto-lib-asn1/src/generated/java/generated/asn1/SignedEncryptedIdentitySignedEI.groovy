...
class SignedEncryptedIdentitySignedEI
    ...
    SignedEncryptedIdentitySignedEI decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable encryptedIdentityReadRequired(SignedEncryptedIdentitySignedEI target, DERSequenceParser parser, ASN1Encodable object) {
    ...
    ASN1Encodable auditElementReadRequired(SignedEncryptedIdentitySignedEI target, DERSequenceParser parser, ASN1Encodable object) {
