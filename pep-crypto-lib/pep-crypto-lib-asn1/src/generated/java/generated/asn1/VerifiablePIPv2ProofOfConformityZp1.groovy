...
class VerifiablePIPv2ProofOfConformityZp1
    ...
    VerifiablePIPv2ProofOfConformityZp1 decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable r1ReadRequired(VerifiablePIPv2ProofOfConformityZp1 target, DERSequenceParser parser, ASN1Encodable object) {
        target.r1 = object.value

        return readObject(parser)
    }

    ASN1Encodable s1ReadRequired(VerifiablePIPv2ProofOfConformityZp1 target, DERSequenceParser parser, ASN1Encodable object) {
