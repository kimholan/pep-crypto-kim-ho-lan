...
class VerifiablePIPv2ProofOfConformity
        implements ASN1Encodable {

    byte[] rawInput
    ECPoint p1
    ECPoint t
    VerifiablePIPv2ProofOfConformityZp1 zp1
    VerifiablePIPv2ProofOfConformityZp2 zp2
    ...
    VerifiablePIPv2ProofOfConformity decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable p1ReadRequired(VerifiablePIPv2ProofOfConformity target, DERSequenceParser parser, ASN1Encodable object) {
    ...
    ASN1Encodable tReadRequired(VerifiablePIPv2ProofOfConformity target, DERSequenceParser parser, ASN1Encodable object) {
        def encoded = object.encoded
        def value = new ECPoint()
    ...
    ASN1Encodable zp1ReadRequired(VerifiablePIPv2ProofOfConformity target, DERSequenceParser parser, ASN1Encodable object) {
        def encoded = object.encoded
        def value = new VerifiablePIPv2ProofOfConformityZp1()
    ...
    ASN1Encodable zp2ReadRequired(VerifiablePIPv2ProofOfConformity target, DERSequenceParser parser, ASN1Encodable object) {
        def encoded = object.encoded
        def value = new VerifiablePIPv2ProofOfConformityZp2()
