...
class VerifiablePIPProofOfConformityZp2
    ...
    VerifiablePIPProofOfConformityZp2 decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable r2ReadRequired(VerifiablePIPProofOfConformityZp2 target, DERSequenceParser parser, ASN1Encodable object) {
        target.r2 = object.value

        return readObject(parser)
    }

    ASN1Encodable s2ReadRequired(VerifiablePIPProofOfConformityZp2 target, DERSequenceParser parser, ASN1Encodable object) {
