...
class DeprecatedSignedEncryptedPseudonymSignedEP
    ...
    DeprecatedSignedEncryptedPseudonymSignedEP decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable encryptedPseudonymReadRequired(DeprecatedSignedEncryptedPseudonymSignedEP target, DERSequenceParser parser, ASN1Encodable object) {
    ...
    ASN1Encodable auditElementReadRequired(DeprecatedSignedEncryptedPseudonymSignedEP target, DERSequenceParser parser, ASN1Encodable object) {
