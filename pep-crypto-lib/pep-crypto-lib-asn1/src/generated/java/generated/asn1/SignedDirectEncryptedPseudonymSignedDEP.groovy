...
class SignedDirectEncryptedPseudonymSignedDEP
        implements ASN1Encodable, nl.logius.pepcrypto.lib.asn1.signeddirectencryptedpseudonym.Asn1SignedDirectEncryptedPseudonymSignedBody {
    ...
    SignedDirectEncryptedPseudonymSignedDEP decodeByteArray(byte[] bytes) {
        def target = this
    ...
    ASN1Encodable directEncryptedPseudonymReadRequired(SignedDirectEncryptedPseudonymSignedDEP target, DERSequenceParser parser, ASN1Encodable object) {
    ...
    ASN1Encodable auditElementReadRequired(SignedDirectEncryptedPseudonymSignedDEP target, DERSequenceParser parser, ASN1Encodable object) {
        target.auditElement = object.octets

        return readObject(parser)
    }

    ASN1Encodable signingKeyVersionReadRequired(SignedDirectEncryptedPseudonymSignedDEP target, DERSequenceParser parser, ASN1Encodable object) {
