...
@ApplicationScoped
public class MicroprofilePseudonymDecryptionKeySelector
        extends MicroprofileAbstractKeySelector {

    public MicroprofilePseudonymDecryptionKeySelector() {
    ...
    public List<PemEcPrivateKey> filterByRecipientKeyId(List<PemEcPrivateKey> serviceProviderKeys, PepRecipientKeyId recipientKeyId) {
        var predicate = predicateForMatchingPepRecipientKeyId(PemEcPrivateKey::isEpDecryptionKey, recipientKeyId);
