 ...
 */
@ApplicationScoped
class MicroprofileSignedDirectEncryptedPseudonymMigrationResponseMapper {

    OASDecryptedPseudonymResponse mapToResponse(MicroprofileSignedDirectEncryptedPseudonymMigrationExchange exchange) {
