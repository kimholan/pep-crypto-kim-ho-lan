...
public class MicroprofilePseudonymClosingKeySelectorTest {

    @InjectMocks
    private MicroprofilePseudonymClosingKeySelector selector;
    ...
    public void filterByRecipientKeyId() {
        ...
        when(expected.isEpClosingKey()).thenReturn(true);
