...
public class MicroprofileIdentityDecryptionKeySelectorTest {

    @InjectMocks
    private MicroprofileIdentityDecryptionKeySelector selector;
    ...
    public void filterByRecipientKeyId() {
        ...
        when(expected.isEiDecryptionKey()).thenReturn(true);
