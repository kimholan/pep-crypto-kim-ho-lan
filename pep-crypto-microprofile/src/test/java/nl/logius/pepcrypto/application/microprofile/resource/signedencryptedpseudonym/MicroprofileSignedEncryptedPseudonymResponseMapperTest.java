...
public class MicroprofileSignedEncryptedPseudonymResponseMapperTest {

    @InjectMocks
    private MicroprofileSignedEncryptedPseudonymResponseMapper mapper;

    @Test
    public void mapToResponse() {
        var exchange = mock(MicroprofileSignedEncryptedPseudonymExchange.class);
