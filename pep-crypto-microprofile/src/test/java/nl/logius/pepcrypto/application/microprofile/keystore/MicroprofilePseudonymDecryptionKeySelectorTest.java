...
public class MicroprofilePseudonymDecryptionKeySelectorTest {

    @InjectMocks
    private MicroprofilePseudonymDecryptionKeySelector selector;
    ...
    public void filterByRecipientKeyId() {
        ...
        when(expected.isEpDecryptionKey()).thenReturn(true);
