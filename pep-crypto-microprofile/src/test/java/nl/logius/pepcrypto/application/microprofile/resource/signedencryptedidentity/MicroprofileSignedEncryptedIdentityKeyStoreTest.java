...
public class MicroprofileSignedEncryptedIdentityKeyStoreTest {

    @InjectMocks
    private MicroprofileSignedEncryptedIdentityKeyStore target;
    ...
    @Mock
    private MicroprofileIdentityDecryptionKeySelector closingKeySelector;
    ...
    public void parseServiceProviderKeys() {
        ...
        var schemeKeys = Map.of(
                "urn:nl-gdi-eid:1.0:pp-key:ENV:012345012345012345012345:IP_P:20190101",
